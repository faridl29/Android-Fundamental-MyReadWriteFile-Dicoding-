...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showList(){
        ...
        val path: File = filesDir //menunjukan internal storage
        Collections.addAll(arrayList, *path.list() as Array<String>) //mengambil semua berkas pada internal storage, lalu tiap berkas dimasukkan ke dalam object arraylist
        val items = arrayList.toTypedArray<CharSequence>()

        val builder = AlertDialog.Builder(this)
        builder.setTitle("Pilih file yang dinginkan")
